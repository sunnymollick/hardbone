...
<form id="create" action="" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="needs-validation" novalidate>
    ...
    <div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-2">
                <label for="">Tax(%)</label>
                <input type="number" min="0" onkeyup="if(this.value<0){this.value= this.value * -1}" class="form-control" id="tax" name="tax" placeholder="Tax" required>
                <span id="error_tax" class="has-error text-danger"></span>
            </div>
            <div class="form-group col-md-2">
            ...
            <div class="form-group col-md-4">
                ...
                <span id="error_currency" class="has-error text-danger"></span>
            </div>
        </div>
        <br>
