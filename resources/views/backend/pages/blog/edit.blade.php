<form id='edit' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-12 col-sm-12">
            ...
            <textarea name="blog_description" id="blog_description" class="form-control" required placeholder="Enter Blog Description">{!! $blog->blog_description !!}</textarea>
        ...
        <div class="form-group col-md-12 col-sm-12">
            ...
            <textarea name="author_description" id="author_description" class="form-control" placeholder="Enter Author Description" required>{{ $blog->author_description }}</textarea>
        ...
        <div class="form-group  col-md-12">
            ...
            <img id="authorlogoPreview" src="{{ asset($blog->author_image) }}" alt="Author Image" height="150">
            <p></p>
            <div class="input-group">
                ...
                <input type="text" name="author_file_name" class="form-control" id="author_file_name" value="{{ $blog->author_image }}" readonly>
            </div>
        ...
        <div class="form-group  col-md-12">
            ...
            <img id="thumbnaillogoPreview" src="{{ asset($blog->thumbnail_image) }}" alt="Thumbnail Image" height="150">
            <p></p>
            <div class="input-group">
                ...
                <input type="text" name="thumbnail_image_name" class="form-control" id="thumbnail_image_name" value="{{ $blog->thumbnail_image }}" readonly>
            </div>
        ...
        <div class="form-group  col-md-12">
            ...
            <img id="logoPreview" src="{{ asset($blog->hero_image) }}" alt="Hero Image" height="150">
            <p></p>
            <div class="input-group">
                ...
                <input type="text" name="SelectedFileName" class="form-control" id="SelectedFileName" value="{{ $blog->hero_image }}" readonly>
            </div>
        ...
        <div class="form-group  col-md-12">
            ...
            <img id="aboutlogoPreview1" src="{{ asset($blog->image_1) }}" alt="About Image" height="150">
            <p></p>
            <div class="input-group">
                ...
                <input type="text" name="image_1_name" class="form-control" id="image_1_name" value="{{ $blog->image_1 }}" readonly>
            </div>
            <span>Image Size Must Be 370 × 260 (width - height) </span>
        ...
        <div class="form-group  col-md-12">
            ...
            <img id="aboutlogoPreview2" src="{{ asset($blog->image_2) }}" alt="About Image" height="150">
            <p></p>
            <div class="input-group">
                ...
                <input type="text" name="image_2_name" class="form-control" id="image_2_name" value="{{ $blog->image_2 }}" readonly>
            </div>
            <span>Image Size Must Be 370 × 260 (width - height) </span>
