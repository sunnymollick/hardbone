    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h6><i class="lni lni-user" aria-hidden="true"></i> &nbsp; All Project Types
...
<script type="text/javascript">
    function create() {
        ajax_submit_create('project_types');
    }
    ...
    $(document).ready(function() {
        ...
        $("#manage_all").on("click", ".edit", function() {
            var id = $(this).attr('id');
            ajax_submit_edit('project_types', id)
        });
        ...
        $("#manage_all").on("click", ".delete", function() {
            var id = $(this).attr('id');
            ajax_submit_delete('project_types', id)
        });
